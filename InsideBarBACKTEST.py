...
class InsideBarBreakoutStrategy:
    ...
    def load_all_market_data(self):
        ...
        csv_files = glob.glob(os.path.join(self.data_path, self.filePattern))
    ...
    def generate_detailed_report(self) -> str:
        ...
        header = ["Symbol", "Direction", "Entry Time", "Entry Price", "Exit Time", "Exit Price", "Size", "InitialRisk (Points)","InitialRisk($)" ,"PnL (Currency)", "Status"]

        # Define format string for the header (all strings)
        header_format_string = "{:<10} {:<10} {:<20} {:<12} {:<20} {:<12} {:<8} {:<20} {:<20} {:<15} {:<10}\n"

        # Define format string for the trade data (mix of strings, floats, ints)
        trade_format_string = "{:<10} {:<10} {:<20} {:<12.2f} {:<20} {:<12.2f} {:<8} {:<20.2f} {:<20.2f} {:<15.2f} {:<10}\n"
        ...
        for trade in self.trades:
            ...
            report_output += trade_format_string.format( # Use the trade format string for trade data
                ...
                initial_risk_currency , # Use the formatted initial risk
                trade.pnl,
                trade.status
            )
        report_output += "="*50 + "\n"
    ...
    def generate_report(self, save_to_files=False, reports_dir="REPORTS"):
        ...
        if save_to_files:
            ...
            detailed_filename = os.path.join(reports_dir, f"detailed_trade_report_{self.entry_tf}.txt")
